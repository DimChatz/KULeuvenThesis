...
data2 = noiseRemover(data1, lowF=0.5, highF=100, samplingF=500)
...
data4 = noiseRemover(data3, lowF=0.5, highF=100, samplingF=500)
...
data6 = noiseRemover(data5, lowF=0.5, highF=100, samplingF=500)
...
data8 = noiseRemover(data7, lowF=0.5, highF=100, samplingF=500)
...
data10 = noiseRemover(data9, lowF=0.5, highF=100, samplingF=500)
...
data12 = noiseRemover(data11, lowF=0.5, highF=100, samplingF=500)
...
data14 = noiseRemover(data13, lowF=0.5, highF=100, samplingF=500) 
...
data16 = noiseRemover(data15, lowF=0.5, highF=100, samplingF=500)
...
data18 = noiseRemover(data17, lowF=0.5, highF=100, samplingF=500)
...
data20 = noiseRemover(data19, lowF=0.5, highF=100, samplingF=500)
